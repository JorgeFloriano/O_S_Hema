...
class FormFilterRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'finished.numeric' => 'Selecione um status de Ordem válido',
            'finished.min' => 'Código de status da ordem tem que ser maior que zero',
            'finished.max' => 'Código de status da ordem tem que ser menor do que 3',
