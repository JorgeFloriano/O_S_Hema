                        ...
                        <tbody>
                            @foreach ($order_types as $order_type)
                                <tr>
                                    ...
                                    @if ($opt === 0)
                                        <td>
                                            <a href="{{route('order_types.edit', ['order_type' => Crypt::encryptString($order_type->id)])}}" class="btn btn-primary btn-sm">
                                    ...
                                    <td>
                                        <a href="{{route($route, ['order_type' => Crypt::encryptString($order_type->id)])}}" class="btn btn-sm {{$btn_color}}">
