                ...
                <main>
                    ...
                    <form action="{{route('causes.update', ['cause' => $cause->id])}}" id="form" method="post" autocomplete="on">
                        ...
                        <div class="form-floating my-2">
                            <input type="text" class="form-control" id="description" name="description" maxlength="25" placeholder="Descrição" value="{{$cause->description}}" required>
                        ...
                        <div class="my-2">
                            ...
                            <a href="{{route('causes.index')}}" class="btn btn-outline-primary">
