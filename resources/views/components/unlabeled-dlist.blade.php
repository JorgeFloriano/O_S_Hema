<div>
    <input list="{{$index.$object}}_list" onchange="getOptId('{{$index.$object}}','{{$index.$object}}_id', '{{$index.$object}}_option', '{{$index}}')" onfocus="{{$onfocus}}" class="form-control" id="{{$index.$object}}" name="{{$index.$object}}" placeholder="{{$placeholder}}" value="{{$value}}">
